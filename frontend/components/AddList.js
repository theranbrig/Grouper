...
class AddList extends Component {
  ...
  render() {
    return (
      <div>
        <h2>Add New List</h2>
        <Mutation mutation={CREATE_LIST_MUTATION} refetchQueries={[{ query: LISTS_QUERY }]} variables={this.state}>
          {(createList, { error, loading }) => (
            <FormStyles>
              ...
              >
                <Message onDismiss={this.handleDismiss} success header="Success!" content="New List Added." />
