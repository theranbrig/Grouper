        ...
        <Grid centered container>
          <Grid.Column mobile={16} tablet={12} computer={8} textAlign="center">
            ...
            <ul>
              <li>
                <Icon name="group" />
                <p>Divide and conquer while you shop. Split up and find what you need around the store.</p>
              </li>
              <li>
                <Icon name="shopping cart" />
                <p>Check off items as you pick them up. Let others know you found what you were looking for.</p>
              </li>
              <li>
                <Icon name="dollar" />
